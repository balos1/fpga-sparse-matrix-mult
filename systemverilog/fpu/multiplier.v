...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV E" EXCEPTION_HANDLING="NO" PIPELINE=6 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock dataa datab nan overflow result underflow zero
...
module  multiplier_altfp_mult_h6r
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	assign
		...
		zero = zero_ff;
endmodule //multiplier_altfp_mult_h6r
//VALID FILE
...
module multiplier (
	...
	multiplier_altfp_mult_h6r	multiplier_altfp_mult_h6r_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
